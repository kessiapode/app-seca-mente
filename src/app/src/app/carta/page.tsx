      ...
      <main className="max-w-md mx-auto p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-600 italic">
            Escreva para a mulher que você já é no futuro. Agradeça a ela por ter
            chegado lá.
          </p>
        </div>
        ...
        {message && (
          <p className="text-center text-orange-600 font-bold text-sm animate-pulse">
            {message}
          </p>
        )}
        ...
        <div className="bg-orange-50 p-6 rounded-3xl border border-orange-100">
          <p className="text-xs text-orange-800 leading-relaxed">
            <strong>Dica da Criadora:</strong> Não escreva o que você "quer" ter.
            Escreva como se você <strong>já tivesse</strong>. Ex: "Obrigada por
            acordar todos os dias se sentindo leve e em paz com o espelho."
          </p>
        </div>
      </main>
    </div>
